...
(async () => {
  ...
  try {
    ...
    assert.strictEqual(checkFail.exitCode, 4, 'Regression failure should produce exit code 4');
    ...
    assert.strictEqual(checkFriction.exitCode, 3, 'Friction regression should produce exit code 3');
